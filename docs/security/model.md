...
Produkce používá HTTPS, HSTS, CSP, zákaz framingu, kontrolu originu, Secure HttpOnly SameSite=Strict cookies a serverové zneplatnění relací. Hesla jsou Argon2id, 8–128 znaků, porovnávaná s lokálním seznamem kompromitovaných hodnot. Resetovací a ověřovací tokeny jsou náhodné, jednorázové, expirované a uložené pouze jako účelově oddělený digest.
